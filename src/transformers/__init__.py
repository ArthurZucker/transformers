...
try:
    ...
    _import_structure["models.llama_code"].append("LlamaCodeTokenizer")
...
try:
    ...
    _import_structure["models.llama_code"].append("LlamaCodeTokenizerFast")
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.llama_code import LlamaCodeTokenizer
